...
--     Check the Explain plan: index scan on admit_da ON te_full_idx
--     1.5 seconds (plan uses the index)
--     3 seconds on the VM
...
CREATE TABLE test.pat_enc (LIKE test.pat_enc_struct INCLUDING ALL) PARTI
