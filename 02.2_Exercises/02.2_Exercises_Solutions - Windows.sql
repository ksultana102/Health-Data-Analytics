...
COPY armc_1k.patients TO 
	'C:\Users\Public\cohe_6590_exercises\data\output\patients_all.csv'
	CSV HEADER;
...
COPY armc_1k.patients TO 
	'C:\Users\Public\cohe_6590_exercises\data\output\patients_all.tsv'
...
COPY armc_1k.patients (patient_id, gender, race) TO 
	'C:\Users\Public\cohe_6590_exercises\data\output\patients_select.csv'
	CSV HEADER;
...
COPY (SELECT * FROM armc_1k.patients WHERE gender = 'F') TO 
	'C:\Users\Public\cohe_6590_exercises\data\output\patients_limited.tsv'
	DELIMITER E'\t' CSV HEADER;
...
COPY covid.nyt_covid FROM 
	'C:\Users\Public\cohe_6590_exercises\data\NYT_COVID.csv'
	CSV HEADER;
...
CREATE TABLE covid.ncd_cli_ili (
	...
	week			TEXT,
	week_end_date	DATE,
	cli				DOUBLE PRECISION,
	ili				DOUBLE PRECISION
);

-- (2) Change datestyle then load the data using COPY with a tab delimiter.
--     datestyle: https://www.postgresql.org/docs/15/datatype-datetime.html
SET datestyle = 'SQL, MDY';
COPY covid.ncd_cli_ili FROM 
	'C:\Users\Public\cohe_6590_exercises\data\NCD_CLI_ILI.txt'
	DELIMITER E'\t' CSV HEADER;
...
COPY covid.fhir FROM 
	'C:\Users\Public\cohe_6590_exercises\data\fhir_json\1.json' ENCODING 'WIN1251';
COPY covid.fhir FROM 
	'C:\Users\Public\cohe_6590_exercises\data\fhir_json\2.json' ENCODING 'WIN1251';
COPY covid.fhir FROM 
	'C:\Users\Public\cohe_6590_exercises\data\fhir_json\3.json' ENCODING 'WIN1251';
COPY covid.fhir FROM 
	'C:\Users\Public\cohe_6590_exercises\data\fhir_json\4.json' ENCODING 'WIN1251';
...
COPY covid.fhir (data) FROM 
	'C:\Users\Public\cohe_6590_exercises\data\output\fhir_json_not_pp\1.json';
COPY covid.fhir (data) FROM 
	'C:\Users\Public\cohe_6590_exercises\data\output\fhir_json_not_pp\2.json';
COPY covid.fhir (data) FROM 
	'C:\Users\Public\cohe_6590_exercises\data\output\fhir_json_not_pp\3.json';
COPY covid.fhir (data) FROM 
	'C:\Users\Public\cohe_6590_exercises\data\output\fhir_json_not_pp\4.json';
