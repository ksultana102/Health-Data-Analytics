...
COPY armc_1k.patients TO 
	'/Users/Shared/cohe_6590_exercises/data/output/patients_all.csv'
	CSV HEADER;
...
COPY armc_1k.patients TO 
	'/Users/Shared/cohe_6590_exercises/data/output/patients_all.tsv'
...
COPY armc_1k.patients (patient_id, gender, race) TO 
	'/Users/Shared/cohe_6590_exercises/data/output/patients_select.csv'
	CSV HEADER;
...
COPY (SELECT * FROM armc_1k.patients WHERE gender = 'F') TO 
	'/Users/Shared/cohe_6590_exercises/data/output/patients_limited.tsv'
	DELIMITER E'\t' CSV HEADER;
